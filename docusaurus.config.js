...
const config = {
    title: 'MSI 2024, Jan 19 2024',  // set this
    tagline: 'Joint Ptychographic Tomography: From Magnetic Vector Potentials to Single Particle Analysis of Biological Samples',
    favicon: 'img/favicon.ico',

    // The url for your site: <url>/<baseUrl>/
    url: 'https://gvarnavi.github.io',  // set this
    baseUrl: '/2024msi-presentation/',  // set this
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ({
            ...
            navbar: {
                title: 'MSI 2024 | bit.ly/msi2024-ptycho',  // set this
                logo: {
                    alt: 'Slides',
                    src: 'img/favicon.svg',
                },
